...
<body>
	...
	<div class="row">
		<div class="column">
			<div class="card">
				<img src="./css/images/mayank.jpeg" style="width:100%">
				<div class="container">
					<h3>MAYANK JINDAL</h3>
					<p class="title">Project Lead | Frontend Developer</p>
					<p>mayank712jindal@gmail.com</p>
				</div>
			</div>
		</div>
		...
		<div class="column">
			<div class="card">
				<img src="./css/images/aaryan.jpg" style="width:100%">
				<div class="container">
					<h3>AARYAN GUPTA</h3>
					<p class="title">Back End Developer</p>
					<p>aaryan0283.cse19@chitkara.edu.in</p>
				</div>
			</div>
		</div>
		...
		<div class="column">
			<div class="card">
				<img src="./css/images/yashbeer.jpeg" style="width:100%">
				<div class="container">
					<h3>YASHBEER SINGH</h3>
					<p class="title">Front End Development</p>
					<p>yashbeer0251.cse19@chitkara.edu.in</p>
				</div>
			</div>
		</div>
	</div>
