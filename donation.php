...
<head>
	<title>City Express | Donation</title>
	<!-- Required meta tags -->
	<meta charset="utf-8">
...
<body>
	...
	<p class="explain">Donate your extra stuff and help someone.
	</p>
	<form>
		...
		<fieldset class="form-group">
			<div class="row">
				<legend class="col-form-label col-sm-2 pt-0">Donate</legend>
				<div class="col-sm-10">
		...
		<div class="form-group row">
			<label for="inputAddress" class="col-sm-2 col-form-label">Address to Collect From</label>
			<div class="col-sm-10">
	...
	<script src="./js/donation.js" charset="utf-8" defer></script>
</body>
