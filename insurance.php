...
<head>
	<title>City Express | Insurance</title>
	<!-- Required meta tags -->
	<meta charset="utf-8">
...
<body>
	...
	<h2>Insurance</h2>
	<p class="explain">Please fill the form below and select the type of insurance you need.
	...
	<form>
		...
		<fieldset class="form-group">
			<div class="row">
				<legend class="col-form-label col-sm-2 pt-0">Type of Insurance</legend>
				<div class="col-sm-10">
					<div class="form-check">
						<input class="form-check-input" type="radio" name="gridRadio" id="gridRadio1"
							value="2 Wheeler Insurance">
					...
					<div class="form-check">
						<input class="form-check-input" type="radio" name="gridRadio" id="gridRadio4" value="Term Plan">
	...
	<script src="./js/insurance.js" charset="utf-8" defer></script>
</body>
