...
<head>
	<title>City Express | Property</title>
	<!-- Required meta tags -->
	<meta charset="utf-8">
...
<body>
	...
	<h2>Property</h2>
	<p class="explain">Please fill the form below and provide all the details as per requirement.
	</p>
	<form>
		...
		<div class="form-group row">
			<label for="inputQuery" class="col-sm-2 col-form-label">Briefly explain the need</label>
			<div class="col-sm-10">
				<input type="text" class="form-control" id="inputRequirement" name="inputRequirement">
			</div>
		</div>
		<div class="form-group row">
			<label for="inputQuery" class="col-sm-2 col-form-label">Looking for something else?</label>
			<div class="col-sm-10">
	...
	<script src="./js/property.js" charset="utf-8" defer></script>
</body>
