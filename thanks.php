...
<head>
	<title>City Express | Thank You</title>
	<!-- Required meta tags -->
	<meta charset="utf-8">
...
<body>
	...
	<!-- Header Ends -->
        ...
        <h2>Your request has been accepted and will be processed soon</h2>
        <center>
        <button type="button" class="btn btn-primary"><a class="homebtn" href="index.php">Back to Home Page</a></button>
        </center>
